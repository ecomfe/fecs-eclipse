...
/**
 * Represents a JSON array. A JSON array is a sequence of elements, which are JSON values (see {@link JsonValue}).
 * <p>
 * Elements can be added using one of the <code>add(name, value)</code> methods. Accepted values are either instances of
 * {@link JsonValue}, strings, primitive numbers, or boolean values. To replace an element of an array, the
