...
/**
 * Represents a JSON object. A JSON object contains a sequence of members, which are pairs of a name and a JSON value
 * (see {@link JsonValue}). Although JSON objects should be used for unordered collections, this class stores members in
 * document order.
 * <p>
 * Members can be added using one of the <code>add(name, value)</code> methods. Accepted values are either instances of
 * {@link JsonValue}, strings, primitive numbers, or boolean values. To override values in an object, the
 * <code>set(name, value)</code> methods can be used. However, not that the <code>add</code> methods perform better than
 * <code>set</code>.
 * </p>
 * <p>
...
public class JsonObject extends JsonValue implements Iterable<Member> {
     ...
     * <code>int</code> value.
     * <p>
     * This method <strong>does not prevent duplicate names</strong>. Adding a member with a name that already exists in
     * the object will add another member with the same name. In order to replace existing members, use the method
     * <code>set(name, value)</code> instead. However, <strong> <em>add</em> is much faster than <em>set</em></strong>
     * (because it does not need to search for existing members). Therefore <em>add</em> should be preferred when
    ...
    /**
     * Sets the value of the member with the specified name to the JSON representation of the specified <code>int</code>
     * value. If this object does not contain a member with this name, a new member is added at the end of the object.
     ...
     * <code>long</code> value. If this object does not contain a member with this name, a new member is added at the
     * end of the object. If this object contains multiple members with this name, only the last one is changed.
     * <p>
     * This method should <strong>only be used to modify existing objects</strong>. To fill a new object with members,
     * the method <code>add(name, value)</code> should be preferred which is much faster (as it does not need to search
     * for existing members).
    ...
    /**
     * Sets the value of the member with the specified name to the JSON representation of the specified
     * <code>float</code> value. If this object does not contain a member with this name, a new member is added at the
     * end of the object. If this object contains multiple members with this name, only the last one is changed.
     * <p>
     * This method should <strong>only be used to modify existing objects</strong>. To fill a new object with members,
     * the method <code>add(name, value)</code> should be preferred which is much faster (as it does not need to search
    ...
    /**
     * Sets the value of the member with the specified name to the JSON representation of the specified
     * <code>double</code> value. If this object does not contain a member with this name, a new member is added at the
     * end of the object. If this object contains multiple members with this name, only the last one is changed.
     * <p>
     * This method should <strong>only be used to modify existing objects</strong>. To fill a new object with members,
     * the method <code>add(name, value)</code> should be preferred which is much faster (as it does not need to search
    ...
    /**
     * Sets the value of the member with the specified name to the JSON representation of the specified
     * <code>boolean</code> value. If this object does not contain a member with this name, a new member is added at the
     * end of the object. If this object contains multiple members with this name, only the last one is changed.
     * <p>
     * This method should <strong>only be used to modify existing objects</strong>. To fill a new object with members,
     * the method <code>add(name, value)</code> should be preferred which is much faster (as it does not need to search
    ...
    /**
     * Sets the value of the member with the specified name to the JSON representation of the specified string. If this
     * object does not contain a member with this name, a new member is added at the end of the object. If this object
     * contains multiple members with this name, only the last one is changed.
     * <p>
     * This method should <strong>only be used to modify existing objects</strong>. To fill a new object with members,
     * the method <code>add(name, value)</code> should be preferred which is much faster (as it does not need to search
     * for existing members).
