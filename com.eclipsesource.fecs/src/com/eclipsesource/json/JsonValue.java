...
/**
 * Represents a JSON value. According to RFC 4627, a JSON value must be an <strong>object</strong>, an
 * <strong>array</strong>, a <strong>number</strong>, a <strong>string</strong>, or one of the literal names
 * <strong>true</strong>, <strong>false</strong>, and <strong>null</strong>.
 * <p>
 * The literal names <strong>true</strong>, <strong>false</strong>, and <strong>null</strong> are represented by the
 ...
 * {@link JsonArray}. Instances of these types can be created using the public constructors.
 * </p>
 * <p>
 * Instances for JSON <strong>numbers</strong> and <strong>strings</strong> can be created using the static factory
 * methods {@link #valueOf(String)}, {@link #valueOf(long)}, {@link #valueOf(double)} , etc.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * If there is no doubt about the type of a JSON value, one of the methods {@link #asObject()}, {@link #asArray()},
 * {@link #asString()}, {@link #asInt()}, etc. can be used to get this value directly in the appropriate target type.
 * </p>
 * <p>
...
public abstract class JsonValue implements Serializable {
     ...
     * <p>
     * Single elements are passed directly to the given writer. Therefore, if the writer is not buffered, wrapping it in
     * a {@link java.io.BufferedWriter BufferedWriter} can drastically improve writing performance.
     * </p>
     *
