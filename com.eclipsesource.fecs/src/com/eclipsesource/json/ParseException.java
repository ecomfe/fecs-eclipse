...
public class ParseException extends RuntimeException {
    ...
    /**
     * Returns the absolute index of the character at which the error occurred. The index of the first character of a
     * document is 0.
     *
    ...
    /**
     * Returns the index of the character at which the error occurred, relative to the line. The index of the first
