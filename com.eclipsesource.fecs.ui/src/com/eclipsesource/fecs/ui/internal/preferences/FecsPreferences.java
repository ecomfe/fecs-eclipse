...
/**
 * Instances of this class provide a copy of the global JSHint preferences. The preference values are read from the
 * preference store on creation. Modified values will be written back to the store only when <code>save()</code> is
 * called.
 * <p>
 * Instances of this class can be accessed concurrently from multiple threads. However, multiple instances should not be
 * used to concurrently write values to the backing store, otherwise updates may be lost.
 * </p>
 */
